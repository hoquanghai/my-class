...
- TUYỆT ĐỐI không tự nghĩ ra nội dung không có trong tài liệu. Văn bản có chỗ trống do công thức bị mất (ví dụ "hàm số ." hoặc phương án chỉ có dấu chấm) thì ghi [thiếu công thức] đúng tại chỗ đó và để isCorrect = null, không đoán công thức hay đáp án.`;
