...
- Marketing `{components.top-nav}` 64px: wordmark trái; liên kết Tính năng, Cách dùng; phải: "Học sinh vào lớp" (secondary) + "Đăng nhập" (text) + "Dùng thử miễn phí" (primary). Dưới 768px gộp vào menu, giữ nút primary.
