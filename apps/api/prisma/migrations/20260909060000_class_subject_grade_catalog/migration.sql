-- Chuẩn hóa môn/khối của lớp sang mã danh mục (packages/shared/src/education.ts).
-- Môn: nhãn tự do cũ → mã; không nhận ra → 'khac'. Khối: giữ số 6–12, bỏ chữ thừa ("Lớp 12" → "12").
UPDATE "Class"
